                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    ListCardContainer(icon: Icons.photo_size_select_small_outlined,text: " ${controller.saleEstateList[index]["floor_space"].toString()}"),

                                    ListCardContainer(icon: Icons.call,text: controller.saleEstateList[index]["broker_mobile"].toString()),
