...
//
//     final buyEstateListResponse = buyEstateListResponseFromJson(jsonString);

import 'dart:convert';

BuyEstateListResponse buyEstateListResponseFromJson(String str) => BuyEstateListResponse.fromJson(json.decode(str));

String buyEstateListResponseToJson(BuyEstateListResponse data) => json.encode(data.toJson());

class BuyEstateListResponse {
  BuyEstateListResponse({
    this.success,
    this.error,
    this.message,
    this.data,
  ...
  factory BuyEstateListResponse.fromJson(Map<String, dynamic> json) => BuyEstateListResponse(
